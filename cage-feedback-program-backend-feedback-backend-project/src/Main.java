...
public class Main {
    ...
    private static void signUp(UserController userController, Scanner scanner) {
        ...
        String batch = scanner.nextLine().toUpperCase();
    ...
    private static void adminMenu(User admin, UserController userController, Scanner scanner) {
        ...
        while (true) {
            ...
            System.out.println("9. Delete a feedback");
            ...
            switch (choice) {
                case 1:
                    ...
                    String batchName = scanner.nextLine().toUpperCase();
                ...
                case 6:
                    System.out.println("Enter batch name:");
                    batchName = scanner.nextLine().toUpperCase();
                ...
                case 9:
                    ...
                    System.out.println("Enter batch name:");
                    String batchToDelete = scanner.nextLine();
                    userController.deleteFeedback(userToDelete, batchToDelete);
                    break;
